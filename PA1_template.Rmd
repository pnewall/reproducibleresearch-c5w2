...
### The total number of missing values in the dataset is `r max_mnsteps`
...
print ("Chart showing total daily steps with imputed NA's")
hg5 <- ggplot(grp_imp_acts, aes(x = ddate, y = totsteps))
hg5 <- hg5 + geom_point(color = "blue", size = 2) + geom_line(color = "blue") + labs(title = "Total Daily Steps with Imputed NA's", x = "Date", y = "Total Steps")
print(hg5)
